 ...
 * @endcode
 */
$settings['hash_salt'] = 'MvTi00__YTmI6iN2_u0DcvHLG5KLcn720F1IRQb6K1PXVzSxlaojXQhUGkyVZQF6LnwMuUyCtQ';
...
// above.
if (file_exists('/var/www/site-php/PROJECT/PROJECT-settings.inc')) {
...
if (getenv('AH_SITE_ENVIRONMENT')) {
  switch ($_ENV['AH_SITE_ENVIRONMENT']) {
    case 'dev':
      ...
      $config['environment_indicator.indicator']['bg_color'] = '#91ba2c';
      $config['environment_indicator.indicator']['fg_color'] = '#ffffff';
      break;
    case 'test':
      $config['environment_indicator.indicator']['name'] = 'Staging';
      $config['environment_indicator.indicator']['bg_color'] = '#ff4c1e';
      $config['environment_indicator.indicator']['fg_color'] = '#ffffff';
      break;
    case 'prod':
      $config['environment_indicator.indicator']['name'] = 'Live';
      $config['environment_indicator.indicator']['bg_color'] = '#0079a3';
      $config['environment_indicator.indicator']['fg_color'] = '#ffffff';
      break;
  }
}
...
/**
 * If we are on Probo, incude the settings.
 */
if (getenv('PROBO_ENVIRONMENT') && file_exists($app_root . '/' . $site_path . '/settings.probo.php')) {
  include $app_root . '/' . $site_path . '/settings.probo.php';
}

/**
 * If we are on lando, incude the settings.
 */
